      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
         <div>
            <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
               <Printer className="w-5 h-5 text-indigo-600" /> Recibos e Faturas
            </h2>
                  ...
                  <div className="flex gap-2">
                    {['compact', 'standard', 'detailed'].map(layout => (
                      <Button
                        ...
                        className={`flex-1 h-10 font-bold capitalize ${settings.receiptLayout === layout ? 'bg-indigo-600 hover:bg-indigo-700' : 'text-slate-600'}`}
                      >
