      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
         <div className="w-full md:w-auto">
            <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
               <Building className="w-5 h-5 text-blue-600 shrink-0" /> Detalhes da Empresa
            </h2>
         ...
         <Button onClick={handleSave} className="h-11 w-full md:w-auto px-6 font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-lg">
