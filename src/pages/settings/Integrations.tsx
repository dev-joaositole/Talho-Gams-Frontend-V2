      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
         <div>
            <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
               <Plug className="w-5 h-5 text-emerald-600" /> Dispositivos Externos
            </h2>
                  ...
                  <div className="animate-in fade-in slide-in-from-top-2">
                     ...
                     <div className="flex gap-2">
                       <Input 
                         ...
                         className="h-12 bg-slate-50 border-slate-200 rounded-xl font-bold font-mono text-emerald-700" 
                       ...
                       >
                         {isScanning ? <Activity className="w-4 h-4 animate-spin" /> : <Zap className="w-4 h-4 text-amber-500" />}
                       </Button>
                     </div>
