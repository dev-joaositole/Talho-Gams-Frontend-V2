  ...
  return (
    <Card className="bg-white p-8 rounded-3xl shadow-lg border-0 w-full">
      <div className="flex items-center justify-between mb-8">
        ...
        <Button variant="ghost" onClick={onClose} className="font-bold text-slate-500 hover:bg-slate-100">Cancelar</Button>
      </div>
      ...
      <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-100">
         <div>
            {step > 1 && (
               <Button variant="outline" onClick={() => setStep(step - 1)} className="h-12 px-6 font-bold rounded-xl border-slate-200">
                  Voltar
               </Button>
            )}
         </div>
         <Button 
            ...
            className="h-12 px-8 font-black bg-slate-800 hover:bg-slate-900 text-white rounded-xl shadow-xl shadow-slate-800/20"
         >
